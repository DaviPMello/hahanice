...
int main(){
    ...
    while (!end){
        ...
        eventCheck(mainWindow, end, rain.active, restart, highscore, carState, menu, mouse, screen);
        ...
        if(menu.state == 0){
            ...
            restartVars(restart, carState, road, npcCar, carHood, pieces, score, lamp, night, rain);
            ...
            drawSprites(render, carState, road, car, npcCar, img, screen, night.active, rain);
